...
func TestMatrixIntegration_SimpleWorkflow(t *testing.T) {
	// 读取测试文件
	data, err := os.ReadFile("../../testdata/fixtures/matrix/simple.yaml")
...
func TestMatrixIntegration_MultiDimensionWorkflow(t *testing.T) {
	data, err := os.ReadFile("../../testdata/fixtures/matrix/multi-dimension.yaml")
	assert.NoError(t, err)
...
func TestMatrixIntegration_MaxParallelWorkflow(t *testing.T) {
	data, err := os.ReadFile("../../testdata/fixtures/matrix/max-parallel.yaml")
	assert.NoError(t, err)
